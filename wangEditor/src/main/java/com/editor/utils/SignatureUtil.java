...
/**
 * 
 * @author WF  2018年7月13日上午10:53:58
 *
 */
public class SignatureUtil {
	 ...
	 * @param smsContent
	 * @param tel
	 * @return 经过MD5加密的短信验证码签名
	 */
	public static String queryArguments(String ACCOUNT_SID,String AUTH_TOKEN, String smsContent,String tel) {
        String timestamp = getTimestamp(); //时间戳
        String sig = MD5(ACCOUNT_SID,AUTH_TOKEN,timestamp);//签名认证
        String str = "accountSid="+ACCOUNT_SID+"&smsContent="+smsContent+"&tel="+tel+"&timestamp="+timestamp+"&sig="+sig;
        return str;
    }
